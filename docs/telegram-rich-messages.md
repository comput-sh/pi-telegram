...
Telegram's Rich Messages APIs are explicitly designed for highly structured content and streamed AI-generated replies. They are a better long-term fit for TelegramPi than legacy `sendMessage` with MarkdownV2.
...
## TelegramPi implementation status
...
## Recommended TelegramPi experience
